...
namespace CacheManager.RedisAsync.Tests
{
    ...
    {
        [Fact]
        public async Task Configuration_CacheManager_ComplexSingleManager()
        {
            ...
            (await cache.AddAsync("key", "value")).Should().BeTrue();
        }

        [Fact]
        public async Task Configuration_CacheManager_ComplexManyManager()
        {
            var key = Guid.NewGuid().ToString();
            var data = new Dictionary<string, string>
            {
        ...
        [Fact]
        public async Task Configuration_CacheManager_ByNameFromMany()
        {
            var key = Guid.NewGuid().ToString();
            var data = new Dictionary<string, string>
            {
        ...
        [Fact]
        public async Task Configuration_CacheManager_AllProperties()
        {
            var data = new Dictionary<string, string>
            {
                {"cacheManagers:0:name", "name"},
        ...
        //    var cache = new BaseCacheManager<string>(config);
        //    cache.AddAsync("key", "value").Should().BeTrue();
        //}
...
//#endif
        ...
        [Fact]
        public async Task Configuration_CacheHandle_KnownType_Dictionary()
        {
            var data = new Dictionary<string, string>
            {
                {"cacheManagers:0:name", "name"},
        ...
        [Fact]
        public async Task Configuration_CacheHandle_AllProperties()
        {
            var key = Guid.NewGuid().ToString();
            var data = new Dictionary<string, string>
            {
        ...
        public async Task Configuration_Backplane_Redis_Valid()
        {
            var key = Guid.NewGuid().ToString();
            var data = new Dictionary<string, string>
            {
            ...
            var cache = new BaseCacheManager<string>(config);
            (await cache.AddAsync(Guid.NewGuid().ToString(), "value")).Should().BeTrue();
        }
        ...
        [Fact]
        public async Task Configuration_LoggerFactory_KnownType_Valid()
        {
            var data = new Dictionary<string, string>
            {
                {"cacheManagers:0:name", "name"},
